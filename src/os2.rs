...
fn glyph_unicode_range(a: &[(u32, &str, u32, u32)], target: &u32) -> u32 {
    let mut start = 0;
    let mut end = a.len();
    while start < end {
        let mid = (start + end) / 2;
